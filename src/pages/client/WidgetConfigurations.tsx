...
export default function WidgetConfigurations() {
  ...
  return (
    <DashboardLayout menuItems={clientMenuItems} title="Shopify & Widgets">
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your Shopify extension widgets. Configure once, deploy anywhere.</p>
          </div>
          <button
            onClick={() => {
              resetForm();
