...
-- NOTE: Seed data for plan_module_entitlements and plan_feature_entitlements
-- is in migration 20260412000002_fix_entitlements_and_subscriptions.sql
-- (that migration drops the check constraint first before seeding)
